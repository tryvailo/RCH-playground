      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white rounded-lg p-4 border border-gray-200">
          ...
          <div className="text-lg font-semibold text-gray-900">
            {analysis.rankings.statistics.highest_score}% - {analysis.rankings.statistics.lowest_score}%
          </div>
          <div className="text-xs text-gray-400 mt-1">
            Avg: {analysis.rankings.statistics.average_score}%
          </div>
        </div>
        <div className="bg-white rounded-lg p-4 border border-gray-200">
          <div className="text-xs text-gray-500 mb-1">Price Range (Weekly)</div>
          <div className="text-lg font-semibold text-gray-900">
            £{analysis.price_comparison.statistics.lowest_weekly.toLocaleString()} - £{analysis.price_comparison.statistics.highest_weekly.toLocaleString()}
          </div>
          <div className="text-xs text-gray-400 mt-1">
            Avg: £{analysis.price_comparison.statistics.average_weekly.toLocaleString()}
          </div>
        </div>
        <div className="bg-white rounded-lg p-4 border border-gray-200">
          <div className="text-xs text-gray-500 mb-1">Best Value</div>
          {analysis.price_comparison.best_value ? (
            <>
