...
import type { QuestionnaireResponse, FreeReportResponse, FreeReportData, CareHomeData, FairCostGapData } from '../types';
...
const transformBackendResponse = (
  ...
  const marketPrice = responseData.fair_cost_gap.market_price;
  const fairCostGap = calculateFairCostGap(marketPrice, msifLowerBound);
