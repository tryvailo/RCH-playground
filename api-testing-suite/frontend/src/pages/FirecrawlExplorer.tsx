              ...
              {(() => {
                ...
                return (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {sd.staff_qualifications && Array.isArray(sd.staff_qualifications) && sd.staff_qualifications.length > 0 && (
                    ...
                    {sd.facilities && Array.isArray(sd.facilities) && sd.facilities.length > 0 && (
                      <div className="border border-gray-200 rounded-lg p-4">
                        <h4 className="font-semibold text-gray-900 mb-2 flex items-center gap-2">
      ...
      {pricingResult && (
        <div className="bg-white rounded-lg shadow p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {/* Residential Care */}
            {(pricingResult.pricing.fee_residential_from || pricingResult.pricing.fee_residential_to) && (
              <div className="border border-gray-200 rounded-lg p-4 bg-green-50">
                <h3 className="font-semibold text-gray-900 mb-2">Residential Care</h3>
                <div className="text-2xl font-bold text-green-700">
                  £{pricingResult.pricing.fee_residential_from || 'N/A'}
                  {pricingResult.pricing.fee_residential_to && pricingResult.pricing.fee_residential_to !== pricingResult.pricing.fee_residential_from && (
            ...
            {/* Nursing Care */}
            {(pricingResult.pricing.fee_nursing_from || pricingResult.pricing.fee_nursing_to) && (
              <div className="border border-gray-200 rounded-lg p-4 bg-blue-50">
                <h3 className="font-semibold text-gray-900 mb-2">Nursing Care</h3>
                <div className="text-2xl font-bold text-blue-700">
                  £{pricingResult.pricing.fee_nursing_from || 'N/A'}
                  {pricingResult.pricing.fee_nursing_to && pricingResult.pricing.fee_nursing_to !== pricingResult.pricing.fee_nursing_from && (
            ...
            {(pricingResult.pricing.fee_dementia_residential_from || pricingResult.pricing.fee_dementia_residential_to) && (
              <div className="border border-gray-200 rounded-lg p-4 bg-purple-50">
                <h3 className="font-semibold text-gray-900 mb-2">Dementia Residential</h3>
                <div className="text-2xl font-bold text-purple-700">
                  £{pricingResult.pricing.fee_dementia_residential_from || 'N/A'}
                  {pricingResult.pricing.fee_dementia_residential_to && pricingResult.pricing.fee_dementia_residential_to !== pricingResult.pricing.fee_dementia_residential_from && (
            ...
            {(pricingResult.pricing.fee_dementia_nursing_from || pricingResult.pricing.fee_dementia_nursing_to) && (
              <div className="border border-gray-200 rounded-lg p-4 bg-indigo-50">
                ...
                <div className="text-2xl font-bold text-indigo-700">
                  £{pricingResult.pricing.fee_dementia_nursing_from || 'N/A'}
                  {pricingResult.pricing.fee_dementia_nursing_to && pricingResult.pricing.fee_dementia_nursing_to !== pricingResult.pricing.fee_dementia_nursing_from && (
            ...
            {/* Respite Care */}
            {(pricingResult.pricing.fee_respite_from || pricingResult.pricing.fee_respite_to) && (
              <div className="border border-gray-200 rounded-lg p-4 bg-orange-50">
                ...
                <div className="text-2xl font-bold text-orange-700">
                  £{pricingResult.pricing.fee_respite_from || 'N/A'}
                  {pricingResult.pricing.fee_respite_to && pricingResult.pricing.fee_respite_to !== pricingResult.pricing.fee_respite_from && (
            ...
            {pricingResult.pricing.pricing_confidence !== undefined && (
              <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                ...
                <div className="text-2xl font-bold text-gray-700">
                  {pricingResult.pricing.pricing_confidence}%
                </div>
