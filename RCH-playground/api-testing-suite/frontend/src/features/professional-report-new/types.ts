...
export interface ProfessionalCareHome {
  ...
  // CQC Rating Trends (from historical data)
  cqcRatingTrends?: {
  ...
  // Financial Stability Charts (from Financial data)
  financialCharts?: {
    altmanZScore?: number | null;
    bankruptcyRisk?: string | null;
  ...
  // Historical Data (aggregated from multiple sources)
  historicalData?: {
    cqcHistory?: Array<{
      date?: string;
      rating?: string;
    ...
    lastFSAInspection?: string | null;
  } | null;

  // LLM Insights (generated during report processing)
  llmInsights?: any | null;
